...
with zipfile.open(os.getenv('HOME') + '/.tmp/rodder/dylanaraps-neofetch-7.1.0-0-g60d07de.zip') as f:
...
with open(os.getenv('HOME') + '/.profile', 'a') as f:
    subprocess.call('export PATH=' + os.getenv('HOME') + '/.local/bin/dylanaraps-neofetch-60d07de:$PATH')
